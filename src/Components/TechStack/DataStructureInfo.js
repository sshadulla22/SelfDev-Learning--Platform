...
import topics from '../Data/DataStructureInfo.json';
import './Global.css';
  ...
  return (
    <div className="container">
      <a className="toggle-btn" onClick={() => setSidebarOpen(!sidebarOpen)} aria-label="Toggle sidebar">
        <Binary size={30} color={sidebarOpen ? "#667eea" : "#4ade80"} />
      </a>

      <div className={`sidebar ${sidebarOpen ? 'open' : 'closed'}`}>
        <div className="sidebar-header">
          <h3 className='nav-title'>Data Structure</h3>
      ...
      <div className="main-content">
        <div className="content-header">
          <h2 className="content-title">
            <Binary size={40} color={sidebarOpen ? "#667eea" : "#4ade80"} />
