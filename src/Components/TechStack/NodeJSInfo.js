...
import topics from '../Data/NodeJS.json';
import './Global.css';
...
function NodeJSInfo() {
  ...
  return (
    <div className="container">
      ...
      >
        <FaNodeJs size={30} color={sidebarOpen ? "#3C873A" : "#4ade80"} />
      </a>
          ...
          {topics.map(topic => (
            ...
            >
              ...
              <span className="topic-title">
                <FaNodeJs size={24} color={sidebarOpen ? "#3C873A" : "#4ade80"} />
                {topic.title}
              </span>
      ...
      <div className="main-content">
        <div className="content-header">
          <h2 className="content-title">
            <FaNodeJs size={40} color={sidebarOpen ? "#3C873A" : "#4ade80"} />
