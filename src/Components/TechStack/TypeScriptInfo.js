...
import topics from '../Data/TypeScriptInfo.json';
import './Global.css';
import { FaCode } from 'react-icons/fa'; // Or any TypeScript icon if you have one
...
function TypeScriptInfo() {
  ...
  return (
    <div className="container">
      ...
      >
        <FaCode size={30} color={sidebarOpen ? "#3178c6" : "#4ade80"} />
      </a>
          ...
          {topics.map(topic => (
            ...
            >
              ...
              <span className="topic-title">
                <FaCode size={24} color={sidebarOpen ? "#3178c6" : "#4ade80"} />
                {topic.title}
              </span>
      ...
      <div className="main-content">
        <div className="content-header">
          <h2 className="content-title">
            <FaCode size={40} color={sidebarOpen ? "#3178c6" : "#4ade80"} />
